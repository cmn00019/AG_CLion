...
namespace AlgGeom
{
	...
	protected:
		struct Material
		{
			...
			Material() : _kdColor(1.0f, 0.5f, 0.0f, 1.0f), _ksColor(.5f), _metallic(.7f), _roughnessK(.3f), _kadTexture(nullptr), _useUniformColor(true), _pointColor(1.0f), _lineColor(1.0f) {}
		};
